...
--				loop
--					io.put_string(" -------------------------------------------------%N")
--					io.put_string("|  Quel est votre identifiant (99 pour quitter)?	 |%N")
--					io.put_string(" -------------------------------------------------%N")
--					io.flush
--					io.read_line
--                			adh_identifiant:=io.last_string
--					if (adh_identifiant.is_equal("99"))
--					then
--						choix_menu:=98
--					elseif (adh_identifiant.is_equal("test"))
--					then
--						io.put_string("OK OK OK OK%N")
--					-- placer ici un elseif avec vérification de l'identifiant adh (prenom+nom) avec les valeurs contenu dans le ARRAY de adherent
--					end
--				end
--			end
